"use client"
import { loadNavigationItem } from "@/utils/functions"
import Link from "next/link"
import { useEffect, useState } from "react"
import { currentNavItem } from "@/utils/constants"
            ...
            <div className="bg-white shadow-lg p-3">
                <nav className="flex justify-between">
                    <div className="lg:pr-16 pr-6">
                        <Link onClick={()=>{setOpenMobileNav(!openMobileNav);setCurrentNav(items[0])}}  className="flex items-center space-x-3 " href={"/"}>
